...
export default function Onboarding() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // 3. NO paywall here. The onboarding paywall used to fire during
      //    generation (before the user saw any value, the worst timing). The
      //    upsell now lives at the value peak: the post-onboarding soft paywall
      //    shown when the user closes /cut-plan after reviewing their free plan
      //    (see CutPlanReview.tsx). The free starter plan still generates below.
