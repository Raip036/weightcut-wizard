...
export const ScoringConfigV1: ScoringConfig = {
  ...
  // driver. `nutritionAdherence` carries real weight (0.15) so logging meals
  ...
  weights: {
    ...
    peak:      { trainingLoad: 0.20, sleep: 0.20, weightCut: 0.25, wellness: 0.20, nutritionAdherence: 0.15 },
    fightWeek: { trainingLoad: 0.15, sleep: 0.25, weightCut: 0.30, wellness: 0.15, nutritionAdherence: 0.15 },
  },
