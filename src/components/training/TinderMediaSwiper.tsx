...
function SwipeCard({
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0 }}
      className="absolute inset-x-4 top-[calc(env(safe-area-inset-top,0px)+72px)] bottom-[calc(env(safe-area-inset-bottom,0px)+120px)] rounded-xs overflow-hidden bg-zinc-900 touch-none"
    >
      {!item.url ? (
