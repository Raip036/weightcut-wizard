            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1 shrink-0">
                {onMinimize && (
                  <button
                    onClick={onMinimize}
                    className="flex items-center gap-1 px-2 py-1 text-xs text-muted-foreground hover:text-foreground transition-colors rounded-xs"
                  >
                ...
                <AnimatePresence>
                  {showCancel && onCancel && (
                    <motion.button
                      ...
                      transition={springs.snappy}
                      onClick={onCancel}
                      className="flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-muted-foreground hover:text-foreground bg-muted/60 hover:bg-func-danger-red/20 hover:text-func-danger-red border border-border/50 rounded-xs transition-colors touch-manipulation"
                    >
                      <X className="w-4 h-4" />
                      Cancel
                    </motion.button>
