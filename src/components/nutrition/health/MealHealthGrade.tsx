 ...
 * A letter badge + progress bar + one persuasive, non-judgmental line. The
 * grade reflects how whole vs processed the meal is, not its macros.
 */
export function MealHealthGrade({ score, worstItem }: MealHealthGradeProps) {
